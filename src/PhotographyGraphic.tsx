function imperial(inches: number) {
...
`}
      ...
      {farFocalPointInInches - nearFocalPointInInches > 18 && (
        <>
          <text
            ...
            textAnchor="end"
          >
            {imperial(nearFocalPointInInches)}
          </text>
          <text
            ...
            textAnchor="middle"
          >
            {imperial(distanceToSubjectInInches)}
          </text>
          <text
            x={farFocalPointInInches}
            y={75.5}
            fontSize={2}
            textAnchor="start"
          >
            {imperial(farFocalPointInInches)}
          </text>
        </>
      )}
      ...
      {/* <path
        className="cls-1"
        transform={`translate(${distanceToSubjectInInches - 4})`}
        d="M6.74.1h1.02c.43.33.95.47,1.44.61,2,.57,2.56,2.07,2.44,3.83-.06.85-.19,1.69-.2,2.54,0,.41-.05.84.07,1.22.35,1.15,1.66,2.13,2.86,2.22.67.05,1.36-.02,1.99.33.93.51,2.09.4,2.87,1.4.58.75,1.54,1.2,1.76,2.26.05.23.23.45.39.65.81,1.04,1.71,2.01,2.41,3.14.78,1.27,1.73,2.43,2.4,3.77.19.39.18.73.03,1.12-.36.91-.73,1.82-1.05,2.75-.39,1.1-.85,2.16-1.37,3.21-.53,1.06-1.47,1.89-1.65,3.12-.02.13-.17.25-.26.37-.44.58-.99,1.07-1.32,1.73-.37.75-.65,1.49-.16,2.31.69,1.16.76,2.4.45,3.7-.13.55-.09,1.11.03,1.67.11.46.32.89.4,1.37.14.84.26,1.68.4,2.52.31,1.92.59,3.83.43,5.78-.06.68.07,1.32.46,1.89.12.17.18.36.21.57.19,1.21.39,2.41.69,3.6.11.45.24.89.22,1.35-.06,1.66.41,3.22.75,4.82.19.91.4,1.84-.13,2.73-.12.2-.04.38.13.54.32.31.45.7.42,1.16-.05.63-.09,1.25.27,1.83.1.15.07.4.06.6-.02.64-.2.82-.83.82-.97,0-1.94,0-2.91,0-.83,0-.86-.02-.8-.86.03-.42.15-.88-.46-1.01-.06-.01-.09-.14-.14-.2-.37-.51-.05-.99.11-1.45.11-.31.11-.49-.19-.67-1.31-.76-1.75-1.93-1.63-3.4.12-1.42.31-2.84.25-4.28-.03-.7-.19-1.37-.6-1.92-.72-.95-.99-2.05-1.07-3.18-.1-1.37-.1-2.73-.69-4.03-.43-.93-.7-1.93-1.07-2.89-.42-1.09-1.03-2.09-1.37-3.21-.19-.63-.46-1.23-.71-1.84-.06-.15-.16-.32-.38-.26-.2.06-.34.18-.33.4.05,1.34-.47,2.64-.19,4.01.17.85.12,1.73.01,2.6-.13,1.09-.11,2.17-.13,3.26,0,.47.04.95-.23,1.39-.12.19-.09.45,0,.65.22.51.14,1.03.1,1.56-.02.27-.1.55-.02.81.33,1.04.44,2.12.56,3.21.18,1.65.12,3.24-.61,4.79-.18.38-.45.83-.34,1.25.16.62.41,1.22.71,1.78.34.62.38.84-.18,1.31-.45.38-.63.82-.53,1.39.02.1.02.2.02.31,0,.5-.21.7-.72.69-.26,0-.51,0-.77,