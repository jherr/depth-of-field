...
export const LargeDog = () => (
  <path
    className="cls-1"
    transform="translate(-8.5 29.5) scale(1.25)"
...
export const HumanAtDesk = () => (
  <path
    className="cls-1"
    transform={`translate(-26.7 19.5) scale(1.1)`}
